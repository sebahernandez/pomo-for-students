...
/**
 * Grainient — animated WebGL grain-gradient background (ported from ReactBits, `ogl` variant).
 * A single WebGL2 context is created once and kept alive across re-renders; prop changes only
 * update shader uniforms (Effect 2), never rebuilding the context. The render loop pauses when
